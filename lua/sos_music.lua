SOS_MUSIC_LIST = {'Hudba/Menu/MenuMain2.wav', 'Hudba/Menu/MenuArab.wav', 'Hudba/Menu/MenuOriginal.wav', 'Hudba/Menu/MenuLeg.wav', 'Hudba/Menu/MenuAmer.wav', 'Hudba/Menu/MenuRus.wav', 'Hudba/Menu/MenuMain.wav', 'Hudba/Menu/MenuRus2.wav'};
SOS_MUSIC_TRACK = -1;
